...
const codeBox = { fontSize: '30px', fontWeight: 'bold' as const, color: 'hsl(192, 60%, 22%)', letterSpacing: '6px', textAlign: 'center' as const, backgroundColor: 'hsl(40, 30%, 96%)', padding: '18px 12px', borderRadius: '10px', margin: '0 0 12px', fontFamily: "'Courier New', monospace" }
